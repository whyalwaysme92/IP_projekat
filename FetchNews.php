...
try{
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<div class="ErrorMessageDiv"><p>Nisu pronađene vesti ili se morate ulogovati.</p></div>';
    }

    $connection->close();

}catch(Exception $e){
    echo '<div class="ErrorMessageDiv"><p>Greška prilikom konektovanja sa bazom podataka.</p></div>';
}
?>