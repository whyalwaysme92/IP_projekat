...
$query = "SELECT IDkorisnika, Ime, Prezime, Telefon, Email, Adresa, Slika FROM korisnici WHERE Tip = '3'";
                        ...
                        <div class="OneReader">
                            ...
                            <div class="ReaderInformations">
                                <div class="ReaderHeadingDiv">
                                    <a href="#"> <?php echo htmlspecialchars($row['Ime']) . " " . htmlspecialchars($row['Prezime']); ?> </a>
                                </div>
                            ...
                            <div class="ReaderButtons">
                                <a href="UpdateReader.php?id=<?php echo $row['IDkorisnika']; ?>">
                                    <button>Ažuriraj</button>
                                </a>
                                <a href="DeleteReader.php?id=<?php echo $row['IDkorisnika']; ?>" onclick="return confirm('Da li ste sigurni?');">
                                    <button>Briši</button>
                                </a>
                            </div>
                        </div>
